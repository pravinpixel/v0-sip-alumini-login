    ...
    <DashboardLayout>
      ...
      <div className="p-4 lg:p-6 bg-white min-h-screen">
                ...
                <div className="flex items-center justify-between pt-2 border-t">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      className="gap-1 text-muted-foreground hover:text-[#E2001D]"
                    >
        ...
        {totalPages > 1 && (
          <div className="flex justify-center mt-6">
            ...
            <Button variant="outline" className="rounded-none border-x-0 bg-transparent">
      ...
      <Dialog open={reportDialogOpen} onOpenChange={setReportDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 mt-4">
            <div className="space-y-2">
              <Label htmlFor="report-remarks">Reason for reporting</Label>
              <Textarea
                id="report-remarks"
            ...
            <div className="flex items-center justify-end gap-2">
              ...
              <Button
                ...
                className="bg-[#E2001D] hover:bg-[#B1040E]"
                disabled={!reportRemarks.trim()}
              >
                Submit Report
              </Button>
            </div>
